...
import { CommonQueryOptions, CommonSuccessResponse, ConsultSuccessResponse } from '../index.types';
export declare enum ConsultKeyTypes {
...
export type GetAllAdvisersResponse = CommonSuccessResponse<TalkLaterSpecialtyDetails[]>;
export declare enum SpecialtyChargeType {
    Paid = "paid",
    Free = "free"
}
...
export declare enum AdviserPreferenceType {
    Both = "BOTH",
...
export type GetAdviserDetailsResponse = CommonSuccessResponse<AdviserUserDetails>;
export type AdviserUserDetails = {
    appointment_count: number;
    user: Pick<TalkLaterAdviserDetails, 'id' | 'name' | 'email' | 'mobile' | 'gender' | 'role' | 'doctor_detail' | 'doctor_speciality' | 'api_token' | 'refresh_token' | 'profile_picture_url' | 'proof_urls' | 'address_line1' | 'address_line2' | 'city_id' | 'state' | 'country_id' | 'postal_code' | 'is_sales_rep' | 'doctor_type' | 'doctor_preference' | 'country_code' | 'district' | 'created_at' | 'updated_at'>;
};
...
export type GetAdviserScheduleDetailsResponse = CommonSuccessResponse<GetAdviserScheduleDetails>;
export type GetAdviserScheduleDetails = Pick<TalkLaterAdviserDetails, 'id' | 'name' | 'email' | 'mobile' | 'gender' | 'role' | 'doctor_detail' | 'doctor_speciality' | 'api_token' | 'refresh_token' | 'profile_picture_url' | 'proof_urls' | 'address_line1' | 'address_line2' | 'city_id' | 'state' | 'country_id' | 'postal_code' | 'is_sales_rep' | 'doctor_type' | 'created_at' | 'updated_at'> & {
...
export type PrebookAdviserTimeSlotProps = Pick<GetAdviserDetailsProps, 'client'> & {
...
export type PrebookAdviserTimeSlotResponse = CommonSuccessResponse<PrebookAdviserTimeSlotResponseData>;
...
export type CreateAdviceBookingProps = Pick<GetAdviserDetailsProps, 'client'> & {
...
export type CreateAdviceBookingResponse = CommonSuccessResponse<ConsultationDetails>;
...
export declare enum CallEndedType {
    Dropped = "Dropped",
    Consulted = "Consulted",
...
export declare enum CallEndedTypeId {
    Dropped = 1,
    Consulted = 2,
    InCompleteConsult = 3,
    Cancelled = 4,
...
export type GetConsultationCallLogsProps = Pick<GetAllAdvisersProps, 'client'> & {
    consultationId: string;
};
export type GetConsultationCallLogsResponse = ConsultSuccessResponse<ConsultationCallLogDetails[], null>;
...
export type ConsultationCallLogUserDetails = Pick<ConsultUserDetails, 'id' | 'name' | 'email' | 'phoneNumber' | 'userType'> & {
    adminUserId: number;
};
export type ConsultationCallLogConsultDetails = Pick<ConsultationDetails, 'id' | 'consultationId' | 'flashConsultationId' | 'callType'> & {
    doctorId: string;
    doctorName: string;
    patientId: string;
    patientName: string;
};
export type RemoveHealthVaultDataByIdProps = Pick<GetAdviserDetailsProps, 'client'> & {
    healthVaultId: string;
};
export type RemoveHealthVaultDataByIdResponse = CommonSuccessResponse<unknown>;
export type GetConsultationMessagesProps = Pick<GetAllAdvisersProps, 'client'> & {
    params: {
        consultation: string;
        take: 50;
    };
...
export type GetConsultationsResponse = ConsultSuccessResponse<ConsultationDetails[], null>;
...
export type GetAllHealthVaultByUserIdResponse = ConsultSuccessResponse<HealthVaultDetails[], null>;
...
export type GetMedicalHistoryItemsResponse = ConsultSuccessResponse<MedicalAndSurgicalHistoryItem[], null>;
...
export type GetPatientMedicalHistoryResponse = ConsultSuccessResponse<PatientMedicalHistory, null>;
export type CreatePatientMedicalHistoryProps = {
    client: AxiosInstance;
    body: Omit<PatientMedicalHistory, 'id' | 'createdAt' | 'updatedAt'>;
};
export type CreatePatientMedicalHistoryResponse = ConsultSuccessResponse<PatientMedicalHistory, null>;
export type UpdatePatientMedicalHistoryProps = CreatePatientMedicalHistoryProps & {
    medicalHistoryId: string;
};
export type UpdatePatientMedicalHistoryResponse = ConsultSuccessResponse<PatientMedicalHistory, null>;
export type GetSurgicalHistoryItemsProps = {
    client: AxiosInstance;
};
export type GetSurgicalHistoryItemsResponse = ConsultSuccessResponse<MedicalAndSurgicalHistoryItem[], null>;
export type GetPatientSurgicalHistoryProps = {
    client: AxiosInstance;
    patientLeadId: number;
};
export type PatientSurgicalHistory = Omit<PatientMedicalHistory, 'medicalHistories'> & {
    surgicalHistories: PatientMedicalHistory['medicalHistories'];
};
export type GetPatientSurgicalHistoryResponse = ConsultSuccessResponse<PatientSurgicalHistory, null>;
export type CreatePatientSurgicalHistoryProps = {
    client: AxiosInstance;
    body: Omit<PatientSurgicalHistory, 'id' | 'createdAt' | 'updatedAt'>;
};
export type CreatePatientSurgicalHistoryResponse = ConsultSuccessResponse<PatientSurgicalHistory, null>;
export type UpdatePatientSurgicalHistoryProps = CreatePatientSurgicalHistoryProps & {
    surgicalHistoryId: string;
};
export type UpdatePatientSurgicalHistoryResponse = ConsultSuccessResponse<PatientSurgicalHistory, null>;
...
export type GetPatientAllergiesHistoryResponse = ConsultSuccessResponse<AllergiesHistory[], null>;
export type CreatePatientAllergenReactionHistoryProps = {
    client: AxiosInstance;
    body: CreatePatientAllergenReactionHistoryBody;
};
export type CreatePatientAllergenReactionHistoryBody = Pick<AllergiesHistory, 'allergenType' | 'consultationFor' | 'reaction'> & {
    allergies: string;
    consultation?: string;
    patient: string;
};
export type CreatePatientAllergenReactionHistoryResponse = ConsultSuccessResponse<AllergiesHistory, null>;
export type RemoveAllergenReactionHistoryByIdProps = {
    client: AxiosInstance;
    allergenReactionHistoryId: string;
};
export type RemoveAllergenReactionHistoryByIdResponse = ConsultSuccessResponse<unknown, null>;
...
export type CreatePrescriptionResponse = ConsultSuccessResponse<CreatePrescriptionData, null>;
...
export type GetAllSymptomsResponse = ConsultSuccessResponse<ClinicalCommonDataDetails[], null>;
export type GetAllDiagnosesProps = {
    client: AxiosInstance;
    params: GetAllSymptomsParams;
    options?: CommonQueryOptions;
};
export type GetAllDiagnosesResponse = ConsultSuccessResponse<ClinicalCommonDataDetails[], null>;
export type GetMedicationDosagesProps = {
    client: AxiosInstance;
};
export type GetMedicationDosagesResponse = ConsultSuccessResponse<ClinicalCommonDataDetails[], null>;
export type GetAllDosagesProps = {
    client: AxiosInstance;
};
export type GetAllDosagesResponse = ConsultSuccessResponse<ClinicalCommonDataDetails[], null>;
export type GetMedicationFrequenciesProps = {
    client: AxiosInstance;
};
export type GetMedicationFrequenciesResponse = ConsultSuccessResponse<ClinicalCommonDataDetails[], null>;
...
export type GetAllConsultationsResponse = ConsultSuccessResponse<ConsultationDetails[], null>;
...
export type GetAdviserEarningDetailsResponse = CommonSuccessResponse<GetAdviserEarningsData>;
...
export type GetAdviserEarningHistoryResponse = CommonSuccessResponse<AdviserEarningTransaction[]>;
...
export type UpdateConsultationEndTypeResponse = ConsultSuccessResponse<ConsultationDetails, null>;
...
export type ConfirmConsultationResponse = ConsultSuccessResponse<ConsultationDetails, null>;
...
export type GetReceiptByConsultationIdResponse = CommonSuccessResponse<GetReceiptByConsultationData>;
export type GetConsultationByIdProps = {
    client: AxiosInstance;
    consultationId: string;
    options?: CommonQueryOptions;
};
export type GetConsultationByIdResponse = ConsultSuccessResponse<ConsultationDetails, null>;
...
export type RescheduleAdviceBookingResponse = CommonSuccessResponse<ConsultationDetails>;
...
export type CreateHealthDocumentResponse = ConsultSuccessResponse<HealthVaultDetails, null>;
...
export type UpdateHealthDocumentResponse = ConsultSuccessResponse<HealthVaultDetails, null>;
export type UploadToHealthVaultResponse = ConsultSuccessResponse<HealthVaultDetails, null>;
export type AddHealthLogProps = {
    client: AxiosInstance;
    body: any;
};
export type AddHealthLogsResponse = ConsultSuccessResponse<AddHealthLogsResponseData, null>;
...
export type GetHealthLogsResponse = ConsultSuccessResponse<GetHealthLogsResponseData[], null>;
export type GetHealthLogsResponseData = Omit<AddHealthLogsResponseData, 'respiratoryRate' | 'sleep' | 'energyConsumed' | 'water' | 'bodyTemperature' | 'bodyFat' | 'isMigrated' | 'user' | 'consultation'> & {
    user: ConsultationCallLogUserDetails;
    consultation: ConsultationCallLogConsultDetails | null;
};
...
export type GetConsultReviewResponse = CommonSuccessResponse<ConsultReviewDetails>;
