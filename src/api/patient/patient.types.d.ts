...
import { CommonPaginationParams, CommonSuccessResponse, PaginatedResponseData } from "../index.types";
import { Lead } from "../user/user.types";
export declare enum PatientKeyTypes {
...
export type GetPatientsResponse = CommonSuccessResponse<PaginatedResponseData<OrganizationUserDetails>>;
...
export type UserDetails = Pick<Lead, "id" | "name" | "mobile_no" | "email" | "comments" | "leads_status" | "channel" | "source" | "organization_id" | "updated_at" | "created_at">;
