...
export type UseQueryOptionsType<TData, T> = Omit<UseQueryOptions<unknown, unknown, TData, [T]>, "queryKey" | "queryFn">;
export declare enum ServiceConfigType {
    Core = "Core",
    Consult = "Consult"
}
...
export type GetClientConfigProps = Pick<CreateClientProps, 'serviceConfig' | 'serviceConfigType' | 'previousToken' | 'type'>;
