...
export declare enum UserKeyTypes {
    GetLeads = "GetLeads",
...
export declare enum LeadActiveStatus {
    Active = 1,
    Inactive = 0
}
export type Lead = {
...
export type LeadCataloguePackage = {
    ...
    catalogue_package: unknown;
    lead_catalogue_package_feature: LeadCataloguePackageFeature[];
};
export declare enum FeatureCategoryId {
    NoOfCalls = 1,
    RayaFlatDiscount = 2,
    LabDiscount = 3,
    MBEPrice = 4,
...
export type LeadCataloguePackageFeature = {
    ...
    created_at: string;
    updated_at: string;
    original_feature_value: string | null;
...
export type GetUserDetailResponse = CommonSuccessResponse<ConsultUserDetails | null>;
...
export declare enum ProfileKeyTypes {
...
export declare enum ConsultUserKeyTypes {
