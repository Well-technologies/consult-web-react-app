...
export const UserProfileMenu = () => {
  ...
  const { name, email, profile_picture_url, userDetail } = useSelector(
    (rootState) =>
  ...
  return (
    <div className="flex flex-col ">
      ...
      >
        <Avatar className="w-10" imageUrl={profile_picture_url || userDetail?.profile_picture_url || undefined} />
        <div className="flex flex-col">
