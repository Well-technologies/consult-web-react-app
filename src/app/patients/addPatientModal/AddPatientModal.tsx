  ...
  return (
    ...
    <form className="space-y-4 md:space-y-6" action="#" onSubmit={submitForm}>
      <div className="flex flex-col gap-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col w-full">
            ...
            <div className="flex w-full gap-1">
              ...
              <FormInput
                register={register}
                disabled={
                  getIsDisabledFormItem(formType, "mobile_no") ||
          ...
          <FormInput
            ...
            disabled={
              getIsDisabledFormItem(formType, "name") ||
              (isRegisteredPatient && isOtpVerified)
            }
            id="name"
            type="text"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormInput
            ...
            disabled={
              getIsDisabledFormItem(formType, "email") ||
              (isRegisteredPatient && !isOtpVerified)
            }
            id="email"
            type="email"
      ...
      <div className="flex flex-col gap-0 ">
        <div
          className={cn(
            "font-semibold relative cursor-pointer text-md bg-secondary-50 rounded-t-md p-2 px-4"
